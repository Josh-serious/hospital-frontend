...
<template>
    ...
    <!-- Add Patient -->
    <v-dialog v-model="showAddDialog" maxWidth="600px">
        <v-form>
            <v-card class="pa-4">
                <v-row>
                ...
                <v-col md="6">
                    <v-text-field label="Last Name" v-model="lastName" variant="outlined" prepend-icon="mdi-account-outline"></v-text-field>
                     ...
                     <v-row>
                    <v-col md="6">
                        <v-text-field label="Email" v-model="email" variant="outlined" prepend-icon="mdi-gmail"></v-text-field>
                    </v-col>
                <v-col md="6">
                  ...
                  <v-row>
                    <v-col md="6">
                        <v-text-field label="Residents" v-model="residents" variant="outlined" prepend-icon="mdi-home-circle-outline"></v-text-field>
                    </v-col>
                <v-col md="6">
                    <v-text-field label="National ID" v-model="nationalId" variant="outlined" prepend-icon="mdi-account-outline"></v-text-field>
                     ...
                     <v-row>
                    <v-col md="6">
                        <v-date-input label="Date of Birth" v-model="dateOfBirth" variant="outlined" prepend-icon="mdi-calendar"></v-date-input>
                    </v-col>
